...
exports.isNthLength = (field, min = 4, max) => body(field).trim().isLength({ min, max }).escape();
...
exports.isGreaterThan = (field, isOptional, gt) => query(field).optional(isOptional).isInt({ gt });
